...
This milestone leverages **LangGraph interrupts** to pause workflows whenever a **dangerous action** is detected.
...
Safe tools are **low-risk actions** that the agent can execute autonomously:
...
Dangerous tools have **real-world impact** and **require human approval**:
...
The agent can now operate autonomously while maintaining **human control over critical actions**, making it ready for **real-world deployment** in upcoming milestones.
